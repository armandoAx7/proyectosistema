    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff> 
                    Bienvenido a la sección de asignar productos de computo, para asignar se tienen que crear modulos de equipos de computos o de laptop para poder agregarle componentes
                        </font>
                </div>
            </div>
        </div>
     ...
     include("conexion.php");
        ...
        <section class="full-reset text-center" style="padding: 40px 0;">
            <article class="tile"data-href="agregarnuevoequipolaptop.php" data-num="<?php echo mysqli_num_rows($lap); ?>">
             <a href="agregarnuevoequipolaptop.php"><div class="tile-icon full-reset"><i class="zmdi zmdi-laptop"></i></div></a>
                <div class="tile-name all-tittles">laptop </div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($lap); ?></div>
            </article>
            <article class="tile"data-href="agregarnuevoequipocomputo.php" data-num="<?php echo mysqli_num_rows($cpu); ?>">
             <a href="agregarnuevoequipocomputo.php"> <div class="tile-icon full-reset"><i class="zmdi zmdi-memory"></i></div></a>  
