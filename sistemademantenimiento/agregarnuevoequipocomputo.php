...
<html lang="es">
<head>
    <title>Registrarequipocomp</title>
    <meta charset="UTF-8">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/chip.png" alt="pdf" class="img-responsive center-box" style="max-width: 210px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff> 
                    Bienvenido a la sección para agregar o asignar nuevo equipo de computo 
                        </font>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <form autocomplete="off" action="opagregarequipo.php" method="post">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Nuevo equipo de computo</div>
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <div class="group-material">
                               ...
                               <select  name="claveuser" > <option value="<?php  $row['claveuser'];  ?>">
                         <?php
            ...
            $resultado=$conexion->query($query);   
                while($row=$resultado->fetch_assoc()){
                 ...
                 ?>          </option>
                           ...
                           <select style="display:none"  name="regcpu" > <option value="-">
                         <?php
            
            include("conexion.php");
    
            $query="SELECT * FROM regcpu ";
            $resultado=$conexion->query($query);   
                while($row=$resultado->fetch_assoc()){
                 ...
                 ?>          </option>
                    ...
                    <select style="display:none"  name="regdisp" > <option value="-">
                         <?php
            
            include("conexion.php");
    
            $query="SELECT * FROM regdisp ";
            $resultado=$conexion->query($query);   
                while($row=$resultado->fetch_assoc()){
               ...
               <select style="display:none"  name="reghdd" > <option value="-">
                         <?php
            
            include("conexion.php");
    
            $query="SELECT * FROM reghdd ";
            $resultado=$conexion->query($query);   
                while($row=$resultado->fetch_assoc()){
               ...
               <select style="display:none"  name="regimpresora" > <option value="-">
                         <?php
            
            include("conexion.php");
    
            $query="SELECT * FROM regimpresora ";
            $resultado=$conexion->query($query);   
                while($row=$resultado->fetch_assoc()){
               ...
               <select style="display:none"  name="regmonitor" > <option value="-">
                         <?php
            
            include("conexion.php");
    
            $query="SELECT * FROM regmonitor ";
            $resultado=$conexion->query($query);   
                while($row=$resultado->fetch_assoc()){
               ...
               <select style="display:none"  name="regmouse" > <option value="-">
                         <?php
            
            include("conexion.php");
    
            $query="SELECT * FROM regmouse ";
            $resultado=$conexion->query($query);   
                while($row=$resultado->fetch_assoc()){
                 ...
                 ?>          </option>
                            ...
                            <select style="display:none"  name="regnbrk" > <option value="-">
                         <?php
            
            include("conexion.php");
    
            $query="SELECT * FROM regnbrk ";
            $resultado=$conexion->query($query);   
                while($row=$resultado->fetch_assoc()){
                 ...
                 ?>          </option>
                            ...
                            <select style="display:none"  name="regteclado" > <option value="-">
                         <?php
            
            include("conexion.php");
    
            $query="SELECT * FROM regteclado ";
            $resultado=$conexion->query($query);   
                while($row=$resultado->fetch_assoc()){
                 ...
                 ?>          </option>
                            ...
                            <div class="group-material">
                                ...
                                <input value="" name="serie" type="text" class="tooltips-general material-control" placeholder="Escribe aquí la serie que llevara el equipo"  required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="">
                            ...
                            <div class="group-material">
                                ...
                                <input readonly value="equipo de computo" name="tdisp" type="text" class="tooltips-general material-control" placeholder="" required="" maxlength="70" data-toggle="tooltip" data-placement="top" title="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                                 <font color= #FFFF00>
                                  <h2>proyecto en que se usara</h2>
                                </font>
                                <input name="proyecto" value="" type="text" class="material-control tooltips-general" placeholder="Escribe aquí el proyecto en que se usara " required="" maxlength="70" data-toggle="tooltip" data-placement="top" title="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                               ...
                               <input name="fecharegistro" type="date" class="material-control tooltips-general" placeholder="Escribe aquí la fecha de registro" required="" pattern="dd/mm/yyyy"   maxlength="4" data-toggle="tooltip" data-placement="top" >
                                <span class="highlight"></span>
                                <span class="bar"></span>
