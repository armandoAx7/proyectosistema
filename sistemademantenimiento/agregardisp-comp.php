...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/modem.png" alt="pdf" class="img-responsive center-box" style="max-width: 210px;">
                </div>
        ...
        <div class="container-fluid">
            <form autocomplete="off" action="agregardispbd.php" method="post">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Nuevos DISP.COMP</div>
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            ...
                            <div class="group-material">
                                ...
                                <input name="marca" type="text" class="tooltips-general material-control" placeholder="Escribe aquí la marca "  required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="">
                            ...
                            <div class="group-material">
                                ...
                                <input name="modelo" type="text" class="tooltips-general material-control" placeholder="Escribe aquí el modelo" required="" maxlength="70" data-toggle="tooltip" data-placement="top" >
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                                ...
                                <input name="procesador" type="text" class="material-control tooltips-general" placeholder="Escribe aquí el tipo del procesador" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                             ...
                             <div class="group-material">
                                ...
                                <input name="tamanohdd" type="text" class="material-control tooltips-general" placeholder="Escribe aquí el tamaño del HDD" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                             ...
                             <div class="group-material">
                                ...
                                <input name="tamanoram" type="text" class="material-control tooltips-general" placeholder="Escribe aquí el tamaño de la memoria RAM" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                             ...
                             <div class="group-material">
                                ...
                                <input name="tiposo" type="text" class="material-control tooltips-general" placeholder="Escribe aquí el tipo del S.O" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                             ...
                             <div class="group-material">
                                ...
                                <input name="maclan" type="text" class="material-control tooltips-general" placeholder="Escribe aquí la mac lan" required="" maxlength="16" data-toggle="tooltip" data-placement="top" title="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                         ...
                         <div class="group-material">
                                ...
                                <input name="macwlan" type="text" class="material-control tooltips-general" placeholder="Escribe aquí la mac wlan" required="" maxlength="16" data-toggle="tooltip" data-placement="top" title="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                         ...
                         <div class="group-material">
                                ...
                                <input name="remotopass" type="text" class="material-control tooltips-general" placeholder="Escribe aquí la E.remoto pass" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                           ...
                           <div class="group-material">
                                ...
                                <input name="fecha" type="date" class="material-control tooltips-general" placeholder="" required="" pattern="dd/mm/yyyy"   maxlength="" data-toggle="tooltip" data-placement="top" >
                                <span class="highlight"></span>
                                <span class="bar"></span>
