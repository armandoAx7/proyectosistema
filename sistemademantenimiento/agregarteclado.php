        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/keyboard_4316.png" alt="pdf" class="img-responsive center-box" style="max-width: 210px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff> 
                    Bienvenido a la sección para agregar nuevos articulos de la categoria Teclado 
                        </font>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <form autocomplete="off" action="agregartecladobd.php" method="post">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Nueva Teclado</div>
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            ...
                            <div class="group-material">
                                ...
                                <input name="marca" type="text" class="tooltips-general material-control" placeholder="Escribe aquí la marca del teclado" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="">
                           ...
                           <div class="group-material">
                                ...
                                <input name="modelo" type="text" class="tooltips-general material-control" placeholder="Escribe aquí la modelo del teclado"  required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                           ...
                           <div class="group-material">
                                ...
                                <input name="serie" type="text" class="tooltips-general material-control" placeholder="Escribe aquí la serie del teclado" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                               ...
                               <input name="fecha" type="date" class="material-control tooltips-general" placeholder="Escribe aquí la fecha de registro" required="" pattern="[dd:mm:yyyy]" maxlength="4" data-toggle="tooltip" data-placement="top" title="Solamente números, sin espacios">
                                <span class="highlight"></span>
                                <span class="bar"></span>
