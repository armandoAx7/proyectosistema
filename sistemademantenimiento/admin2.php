        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                ...
                <li role="presentation" ><a href="admin.php">Administrador</a></li>
                 <li role="presentation"  class="active"><a href="admin2.php">Administrador secundario</a></li>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div id="wrapper" class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                         <font color= #fff> 
                    Bienvenido a la sección para registrar nuevos administradores secundarios del sistema, debes de llenar todos los campos del siguiente formulario para registrar un administrador
                    </font>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li class="active">Nuevo administrador secundario</li>
                      <li><a href="listadmin2.php">Listado de administradores secundarios</a></li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="container-flat-form">
                ...
                <form autocomplete="off" action="agregaradmin2.php"   method="post">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            ...
                            <font color= #FFFF00>
                                ...
                                <input autocomplete="off" name="id" type="text" class="material-control tooltips-general" placeholder="Nombre completo" required="" maxlength="70" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,70}" data-toggle="tooltip" data-placement="top" title="Escribe id">
                             ...
                             <div class="group-material">
                                ...
                                <input autocomplete="new-password" name="passwor" type="password" class="material-control tooltips-general" placeholder="Contraseña" required="" maxlength="15" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                                ...
                                <input name="email" type="email" class="material-control tooltips-general" placeholder="E-mail"  maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el Email del administrador">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                           ...
                           <div class="group-material" >
                               ...
                               <font color= #FFFF00>
                                ...
                                <input name="nombre" type="text" class="material-control tooltips-general input-check-user" placeholder="Nombreadministrador"  required="" maxlength="20" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ]{1,20}" data-toggle="tooltip" data-placement="top" title="Escribe el nombre del quien se registrara">
                                <span class="highlight"></span>
                                <span class="bar"></span>
