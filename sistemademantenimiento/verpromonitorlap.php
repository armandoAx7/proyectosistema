...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/Monitor-icon.png" alt="user" class="img-responsive center-box" style="max-width: 210px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de monitores registrados en el sistema, puedes dar de baja  o asignar algun producto al personal o usuarios siempre y cuando esten registrados.</font><br>
        ...
        <div class="container-fluid">
              ...
              <font color= #fff>
            <h2  class="text-center all-tittles" style="clear: both; margin: 25px 0;"> listado de monitores </h2>
                  </font>
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:  #96abc9  ; font-weight:bold;">
                        <div class="div-table-cell" style="width: 16%;">#</div>
                        <div class="div-table-cell" style="width: 16%;">serie</div>
                        <div class="div-table-cell" style="width: 16%;">Marca</div>
                        <div class="div-table-cell" style="width: 16%;">Modelo</div>
                       
                        <div class="div-table-cell" style="width: 16%;">Fecha.reg</div>
                       
                        
                       
                       
                        <div class="div-table-cell" style="width: 16%;">Asignar</div>
                    </div>
                </div>
...
<?php
        ...
        $row3=$resultado3->fetch_assoc();
          ...
          ?>
            ...
            $query="SELECT * FROM regmonitor WHERE estado  <> 'baja'AND asignado <> 'si'and estado <>'-'";
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list">
                            <div class="div-table-cell" style="width: 16%;"><?php echo ''.$p.''        ?></div>
                            <div class="div-table-cell" style="width: 16%;"><?php echo $row['serie'];?></div>
                        <div class="div-table-cell" style="width: 16%;"><?php echo $row['marca'];?></div>
                        <div class="div-table-cell" style="width: 16%;"><?php echo $row['modelo'];?></div>
                       
                        <div class="div-table-cell" style="width: 16%;"><?php echo $row['fecha'];?></div>
                       
                            
                            <div class="div-table-cell" style="width: 16%;">
                           <a href="entregarmoncomplap.php?serie=<?php echo $row['serie'];?>&serieentrega=<?php  echo $row3['serieentrega'];  ?>">
