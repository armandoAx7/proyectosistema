    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/mouse.png" alt="user" class="img-responsive center-box" style="max-width: 210px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de mouses para equipo de computo que han sido asignados por el sistema.</font>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <form class="pull-right" style="width: 30% !important;" autocomplete="off">
              ...
              <font color= #fff>
            <h2  class="text-center all-tittles" style="clear: both; margin: 25px 0;"> listado de mauses</h2>
                  </font>
...
<?php
            ...
            $query="SELECT o.fecharegistro,o.claveuser,m.modelo,m.serie,d.folio FROM equipodecomputo AS o inner JOIN regmouse AS m ON o.seriemouse=m.serie INNER JOIN formatoasignacion AS d on o.seriecomp=d.serie";
