...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff> 
                    Bienvenido a la sección para modificar articulos de la categoria reg-nbrk
                        </font>
                </div>
            </div>
        </div>
         ...
         <?php
            ...
            $query="SELECT * FROM regnbrk WHERE serie='$serie'";
        ...
        <div class="container-fluid">
            <form autocomplete="off" action="modificarproregnbrk.php?id=<?php echo $row['serie'];    ?>" method="post">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">modificar reg-nbrk</div>
                    <div class="row">
