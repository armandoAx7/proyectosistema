        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentran los reportes de asignación .</font>
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:  #96abc9  ; font-weight:bold;">
                        ...
                        <div class="div-table-cell" style="width: 9%;">clave</div>
                        <div class="div-table-cell" style="width: 20%;">nombre</div>
                        <div class="div-table-cell" style="width: 9%;">area</div>
                            <div class="div-table-cell" style="width: 9%;">proyecto</div>
                        <div class="div-table-cell" style="width: 19%;">fecha_asig.</div>
                       
                       
                      
                        <div class="div-table-cell" style="width: 9%;">reporte</div>
                        
                         <div class="div-table-cell" style="width: 9%;">imprimir</div>
...
<?php
            ...
            $query="SELECT o.nombre,o.claveuser,o.proceso,m.proyecto,m.tipodispositivo,d.fecha,d.folio FROM usuario AS o inner JOIN equipodecomputo AS m ON o.claveuser=m.claveuser INNER JOIN formatoasignacion AS d on m.seriecomp=d.serie";
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list">
                            ...
                            <div class="div-table-cell" style="width: 9%;"><?php echo $row['claveuser'];   ?></div>
                        <div class="div-table-cell" style="width: 20%;"><?php echo $row['nombre'];   ?></div>
                        <div class="div-table-cell" style="width: 9%;"><?php echo $row['proceso'];   ?></div>
                        <div class="div-table-cell" style="width: 9%;"><?php echo $row['proyecto'];   ?></div>
                      
                       <div class="div-table-cell" style="width: 19%;"><?php echo $row['fecha'];   ?></div>
                       
                         <div class="div-table-cell" style="width: 9%;">
                              <a href="verformasig.php?folio=<?php echo $row['folio'];   ?>">  <button class="btn btn-primary"><i class="zmdi zmdi-file"></i></button></a>
                            </div>
  <div class="div-table-cell" style="width: 9%;">
                              <a href="./proceso/formatoasigimp.php?folio=<?php echo $row['folio'];   ?>">  <button class="btn btn-success"><i class="zmdi zmdi-print"></i></button></a>
                            </div>
...
<?php
            ...
            $query2="SELECT o.nombre,o.claveuser,o.proceso,m.proyecto,m.tipodispositivo,d.fecha,d.folio FROM usuario AS o inner JOIN entregalaptop AS m ON o.claveuser=m.claveuser INNER JOIN formatoasiglap AS d on m.serieentrega=d.serie";
            $resultado2=$conexion->query($query2);   
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list">
                            <div class="div-table-cell" style="width: 9%;"><?php echo $row2['folio'];   ?></div>
                            <div class="div-table-cell" style="width: 9%;"><?php echo $row2['tipodispositivo'];   ?></div>
                            <div class="div-table-cell" style="width: 9%;"><?php echo $row2['claveuser'];   ?></div>
                        <div class="div-table-cell" style="width: 20%;"><?php echo $row2['nombre'];   ?></div>
                        <div class="div-table-cell" style="width: 9%;"><?php echo $row2['proceso'];   ?></div>
                        <div class="div-table-cell" style="width: 9%;"><?php echo $row2['proyecto'];   ?></div>
                      
                       <div class="div-table-cell" style="width: 19%;"><?php echo $row2['fecha'];   ?></div>
                       
                         <div class="div-table-cell" style="width: 9%;">
                              <a href="verformasiglap.php?folio=<?php echo $row2['folio'];   ?>">  <button class="btn btn-primary"><i class="zmdi zmdi-file"></i></button></a>
                            </div>
  <div class="div-table-cell" style="width: 9%;">
                              <a href="./proceso/formatoasigimplap.php?folio=<?php echo $row2['folio'];   ?>">  <button class="btn btn-success"><i class="zmdi zmdi-print"></i></button></a>
                            </div>
