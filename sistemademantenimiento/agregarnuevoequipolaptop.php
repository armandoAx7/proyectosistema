        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff> 
                    Bienvenido a la sección para agregar o asignar nuevo equipo de laptop
                        </font>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <form autocomplete="off" action="opagregarequipolap.php" method="post">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Nuevo equipo de laptop</div>
                    <div class="row">
            ...
            $resultado=$conexion->query($query);   
                while($row=$resultado->fetch_assoc()){
                 ...
                 ?>          </option>
                           ...
                           <select style="display:none"  name="reglaptop" > <option value="-">
                         <?php
            
            include("conexion.php");
    
            $query="SELECT * FROM reglaptop ";
            $resultado=$conexion->query($query);   
                while($row=$resultado->fetch_assoc()){
                ...
                while($row=$resultado->fetch_assoc()){
                 ...
                 ?>          </option>
                            ...
                            <div class="group-material">
                                ...
                                <input readonly value="equipo de laptop" name="tdisp" type="text" class="tooltips-general material-control" placeholder="" required="" maxlength="70" data-toggle="tooltip" data-placement="top" title="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
