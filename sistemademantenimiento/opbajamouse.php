...
$insertar= "INSERT INTO bajamouse (`folio`, `serie`, `modelo`, `fechabaja`, `observaciones`) VALUES ('$folio', '$serie', '$modelo', '$fechabaja', '$observaciones')";
//verificar que el usuario no se repita
$verificar_mouse =mysqli_query ($conexion,"SELECT * FROM bajamouse WHERE serie='$serie' ");

if(mysqli_num_rows($verificar_mouse)>0){
    
    
    header ("Location: bajamouse.php");
    
  echo '<script >
                    alert("el dispositivo ya se ha dado de baja");
                 window.location="bajamouse.php" 
                </script>'; 
