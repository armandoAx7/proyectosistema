...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url();">
       <nav class="navbar-user-top full-reset">
        ...
        <form autocomplete="off" action="guardarformatoasiglap.php" method="post">
        <div class="container">
...
VERSIÓN: 01
    ...
    <h2 class="text-center all-tittles">RESPONSIVA DE BIENES DE TI  </h2>
          ...
          <div  class="table-responsive">
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        ...
                        <div class="div-table-cell" style="width: 20%;"><input type="date" size="15" maxlength="30" value=" <?php echo date("d/m/Y")  ?>" 
                        	name="fecha"></div>
          ...
          $serieentrega=$_REQUEST['serieentrega'];
            $query2="SELECT o.tipodisp,o.serie,o.marca,o.modelo,m.serieentrega FROM reglaptop as o  INNER JOIN entregalaptop as m on o.serie=m.serielap WHERE m.serieentrega='$serieentrega '  ";
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        ...
                        <div class="div-table-cell" style="width: 20%;"><?php echo $row2['modelo'];    ?>
                         ...
                         <div  class="div-table-cell" style="width: 20%;"><input style="border: none;background-color:#DCDAD9;text-align: center; " value="<?php echo $row2['serieentrega'];    ?>" type="" name="serieentrega"></div>
 ...
 $serieentrega=$_REQUEST['serieentrega'];
            $query4="SELECT o.tipodisp,o.serie,o.marca,o.modelo,m.serieentrega,m.fecharegistro FROM regmonitor as o  INNER JOIN entregalaptop as m on o.serie=m.seriemonitor WHERE m.serieentrega='$serieentrega '  ";
 ...
 $serieentrega=$_REQUEST['serieentrega'];
            $query6="SELECT o.tipodisp,o.serie,o.marca,o.modelo,m.serieentrega,m.fecharegistro FROM regmouse as o  INNER JOIN entregalaptop as m on o.serie=m.seriemouse WHERE m.serieentrega='$serieentrega '  "; 
...
$serieentrega=$_REQUEST['serieentrega'];
            $query7="SELECT o.tipodisp,o.serie,o.marca,o.modelo,m.serieentrega,m.fecharegistro FROM regimpresora as o  INNER JOIN entregalaptop as m on o.serie=m.serieimpresora WHERE m.serieentrega='$serieentrega '  "; 
...
$serieentrega=$_REQUEST['serieentrega'];
            $query8="SELECT o.tipodisp,o.serie,o.marca,o.modelo,m.serieentrega,m.fecharegistro FROM reghdd as o  INNER JOIN entregalaptop as m on o.serie=m.seriehdd WHERE m.serieentrega='$serieentrega '  "; 
...
$serieentrega=$_REQUEST['serieentrega'];
            $query9="SELECT o.tipodisp,o.serie,o.marca,o.modelo,m.serieentrega,m.fecharegistro FROM regnbrk as o  INNER JOIN entregalaptop as m on o.serie=m.seriereg WHERE m.serieentrega='$serieentrega '  "; 
...
$serieentrega=$_REQUEST['serieentrega'];
            $query10="SELECT o.tipodisp,o.serie,o.marca,o.modelo,m.serieentrega,m.fecharegistro FROM regdisp as o  INNER JOIN entregalaptop as m on o.serie=m.seriedisp WHERE m.serieentrega='$serieentrega '  "; 
