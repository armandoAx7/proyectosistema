...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff> 
                    Bienvenido a la sección para modificar articulos de la categoria impresora 
                        </font>
                </div>
            </div>
        </div>
          ...
          <?php
            ...
            $query="SELECT * FROM regimpresora WHERE serie='$serie'";
        ...
        <div class="container-fluid">
            <form autocomplete="off" action="modificarproimpresora.php?id=<?php echo $row['serie'];    ?>" method="post">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">modificar impresora</div>
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <div class="group-material">
                            ...
                            <div class="group-material">
                                ...
                                <input value="<?php echo $row['modelo'];    ?>" name="modelo" type="text" class="tooltips-general material-control" placeholder="Escribe aquí el modelo " required="" maxlength="70" data-toggle="tooltip" data-placement="top" title="Escribe el modelo del monitor">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                                ...
                                <input value="<?php echo $row['color'];    ?>" name="color" type="text" class="tooltips-general material-control" placeholder="Escribe aquí el color " required="" maxlength="70" data-toggle="tooltip" data-placement="top" title="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
