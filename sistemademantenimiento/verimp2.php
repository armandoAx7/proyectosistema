            ...
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:  #96abc9  ; font-weight:bold;">
                        ...
                        <div class="div-table-cell" style="width: 20%;">descripcion</div>
                        <div class="div-table-cell" style="width: 20%;">Marca</div>
                        <div class="div-table-cell" style="width: 20%;">Modelo</div>
                       <div class="div-table-cell" style="width: 20%;">Color</div>
                        <div class="div-table-cell" style="width: 9;">Fecha.reg</div>
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list">
                             <div class="div-table-cell" style="width: 20%;"><?php echo ''.$p.''        ?></div>
                            <div class="div-table-cell" style="width: 20%;"><?php echo $row['serie'];?></div>
                             <div class="div-table-cell" style="width: 20%;"><?php echo $row['descripcion'];?></div>
                        <div class="div-table-cell" style="width: 20%;"><?php echo $row['marca'];?></div>
                        <div class="div-table-cell" style="width: 20%;"><?php echo $row['modelo'];?></div>
                         <div class="div-table-cell" style="width: 20%;"><?php echo $row['color'];?></div>
                        <div class="div-table-cell" style="width: 9;"><?php echo $row['fecha'];?></div>
