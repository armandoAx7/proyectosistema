    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/generic_mouse-512.png" alt="user" class="img-responsive center-box" style="max-width: 210px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de mouse registrados en el sistema, puedes dar de baja  o asignar algun producto al personal o usuarios siempre y cuando esten registrados.</font><br>
        ...
        $row3=$resultado3->fetch_assoc();
          ...
          ?>
            ...
            $query="SELECT * FROM regmouse WHERE estado  <> 'baja' AND asignado <> 'si' and estado <> '-'";
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        ...
                        <div class="div-table-cell" style="width: 9;"><?php echo $row['fecha'];?></div>
                           ...
                           <a href="entregarmousecomplap.php?serie=<?php echo $row['serie'];?>&serieentrega=<?php  echo $row3['serieentrega'];   ?>">
                                <button type="submit" class="btn btn-warning"><i class="zmdi zmdi-account-add"></i></button></a>
                            </div>
                        </div>
                    </div>
                </div>
