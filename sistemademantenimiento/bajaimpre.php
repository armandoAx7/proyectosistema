...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de impresoras han sido dado de baja en el sistema.</font>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
              ...
              <font color= #fff>
            <h2  class="text-center all-tittles" style="clear: both; margin: 25px 0;"> listado de bajas de impresoras</h2>
                  </font>
