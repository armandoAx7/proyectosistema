        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de CPU que han sido asignados por el sistema.</font>
                </div>
            </div>
        </div>
...
<?php
            ...
            $query="SELECT o.fecharegistro,o.claveuser,m.modelo,m.serie,d.folio FROM equipodecomputo AS o inner JOIN regcpu AS m ON o.seriecpu=m.serie INNER JOIN formatoasignacion AS d on o.seriecomp=d.serie";
