...
<body>
   ...
   while ($row=$resultado->fetch_assoc()){
                       ...
                       <div class="div-table-cell" style="width: 19%;"><?php echo $row['fechamantenimiento'];   ?></div>
                        <div class="div-table-cell" style="width: 20%;"><?php echo $row['proxmantenimiento'];   ?></div>
                         <div class="div-table-cell" style="width: 9%;">
                           ...
                           <div class="div-table-cell" style="width: 9%;">
                                 <a href="./proceso/formatomantenimientocpuimp.php?folio=<?php echo $row['folio']   ?>">  <button class="btn btn-success"><i class="zmdi zmdi-print"></i></button></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            $query2="SELECT m.claveuser,m.proceso,o.tipodispositivo,o.proyecto,o.serieentrega,d.folio,d.fechamantenimiento,d.proxmantenimiento FROM entregalaptop AS o inner JOIN usuario AS m ON m.claveuser=o.claveuser INNER JOIN formatomantenimientolap as d on d.serieentrega=o.serieentrega";
   ...
   while ($row2=$resultado2->fetch_assoc()){
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        ...
                        <div class="div-table-cell" style="width: 9%;"><?php echo $row2['serieentrega'];   ?></div>
                      
                       <div class="div-table-cell" style="width: 19%;"><?php echo $row2['fechamantenimiento'];   ?></div>
                        <div class="div-table-cell" style="width: 20%;"><?php echo $row2['proxmantenimiento'];   ?></div>
                         <div class="div-table-cell" style="width: 9%;">
                              <a href="verformatodemantenimientolap.php?folio=<?php echo $row2['folio']   ?>"> <button class="btn btn-primary"><i class="zmdi zmdi-file"></i></button> </a> 
                            </div>
                           <div class="div-table-cell" style="width: 9%;">
                                <a href="./proceso/formatomanimplap.php?folio=<?php echo $row2['folio'];   ?>">  <button class="btn btn-success"><i class="zmdi zmdi-print"></i></button></a>
                            </div>
                        </div>
                    </div>
                </div>
