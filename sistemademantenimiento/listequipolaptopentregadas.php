...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de equipos de computo.</font>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
              ...
              <font color= #fff>
            <h2  class="text-center all-tittles" style="clear: both; margin: 25px 0;"> listado de equipo de computo </h2>
                  </font>
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:  #96abc9  ; font-weight:bold;">
                        <div class="div-table-cell" style="width: 14%;">usuario</div>
                        <div class="div-table-cell" style="width: 14%;">proceso</div>
                        <div class="div-table-cell" style="width: 14%;">proyecto</div>
                       ...
                       <div class="div-table-cell" style="width: 14%;">modelo</div>
                        <div class="div-table-cell" style="width: 14;">dar mantenimiento</div>
            ...
            $query="SELECT m.claveuser,m.proceso,o.proyecto,o.serieentrega,d.marca,d.modelo FROM entregalaptop AS o inner JOIN usuario AS m ON m.claveuser=o.claveuser INNER JOIN reglaptop as d on d.serie=o.serielap";
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list">
                             <div class="div-table-cell" style="width: 14%;"><?php  echo  $row['claveuser'];?></div>
                        <div class="div-table-cell" style="width: 14%;"><?php  echo  $row['proceso'];?></div>
                        <div class="div-table-cell" style="width: 14%;"><?php  echo  $row['proyecto'];?></div>
                        <div class="div-table-cell" style="width: 14%;"><?php  echo  $row['serieentrega'];?></div>
                       ...
                       <div class="div-table-cell" style="width:14 %; text-align: center;">
                        <a href="formatolapmantenimiento.php?serieentrega=<?php echo  $row['serieentrega']; ?>">
                                <button class="btn btn-warning"><i class="zmdi zmdi-file"></i></button></a>
                            </div>
