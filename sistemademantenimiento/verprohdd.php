        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de HDD registrados en el sistema </font><br>
                       ...
                       <div class="div-table-cell" style="width: 11%;"><?php echo $row['color'];?></div>
                        ...
                        <div class="div-table-cell" style="width:11% ;"><?php echo $row['fecha'];?></div>
                            ...
                            <div class="div-table-cell" style="width: 11%;">
                             <a href="entregarhddcomp.php?serie=<?php echo $row['serie'];?>&seriecomp=<?php  echo "$seriecomp"   ?>&seriecpu=<?php echo "$seriecpu" ?>&seriemonitor=<?php echo "$seriemonitor" ?>&seriet=<?php echo "$seriet" ?>&seriemouse=<?php echo "$seriemouse"  ?>&serieimpresora=<?php echo "$serieimpresora"  ?> ">
