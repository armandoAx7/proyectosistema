    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
            ...
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:  #96abc9  ; font-weight:bold;">
                         <div class="div-table-cell" style="width: 14%;">#</div>
                        <div class="div-table-cell" style="width: 14%;">serie</div>
                        <div class="div-table-cell" style="width: 14%;">descripcion</div>
                        <div class="div-table-cell" style="width: 14%;">Marca</div>
                        <div class="div-table-cell" style="width: 14%;">Modelo</div>
                       
                        <div class="div-table-cell" style="width: 14%;">Fecha.reg</div>
                       
                        
                       
                        <div class="div-table-cell" style="width: 14%;">Asignar</div>
                    </div>
                </div>
                 <?php
        ...
        $row3=$resultado3->fetch_assoc();
          ...
          ?>
            ...
            $query="SELECT * FROM regnbrk WHERE estado  <> 'baja'AND asignado <> 'si' and estado <> '-'";
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list">
                             <div class="div-table-cell" style="width: 14%;"><?php echo ''.$p.''        ?></div>
                            <div class="div-table-cell" style="width: 14%;"><?php echo $row['serie'];?></div>
                             <div class="div-table-cell" style="width: 14%;"><?php echo $row['descripcion'];?></div>
                        <div class="div-table-cell" style="width: 14%;"><?php echo $row['marca'];?></div>
                        <div class="div-table-cell" style="width: 14%;"><?php echo $row['modelo'];?></div>
                       
                        <div class="div-table-cell" style="width: 14%;"><?php echo $row['fecha'];?></div>
                       
                           <div class="div-table-cell" style="width: 14%;">
                            <a  href="entregarregcomplap.php?serie=<?php echo $row['serie'];?>&serieentrega=<?php  echo  $row3['serieentrega'];   ?>"  >
