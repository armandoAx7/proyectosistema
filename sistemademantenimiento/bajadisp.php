        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de dispositivos de comunicacion han sido dado de baja en el sistema.</font>
                </div>
            </div>
        </div>
                 ...
                 <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        ...
                        <div class="div-table-cell" style="width: 9;"><?php echo $row['fechabaja'];?></div>
                         ...
                         <div class="div-table-cell" style="width: 50%;"><?php echo $row['observacion'];?></div>
