    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                ...
                <li role="presentation"  class="active"><a href="admin.php">Administrador</a></li>
                 <li role="presentation"  class=""><a href="admin2.php">Administrador secundario</a></li>
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form autocomplete="off" action="agregaradmin.php"   method="post">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <div class="group-material">
                                ...
                                <input name="privilegio" readonly="readonly" type="text" class="material-control tooltips-general" placeholder="administrador" value="administrador"  maxlength="40" data-toggle="tooltip" data-placement="top" title="administrador">
                                <span class="highlight"></span>
                                <span class="bar"></span>
