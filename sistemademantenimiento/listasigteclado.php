    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/keyboard_4316.png" alt="user" class="img-responsive center-box" style="max-width: 210px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de teclados para equipo de computo que han sido asgnados por sistema.</font>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <form class="pull-right" style="width: 30% !important;" autocomplete="off">
              ...
              <font color= #fff>
            <h2  class="text-center all-tittles" style="clear: both; margin: 25px 0;"> listado de teclados de computo</h2>
                  </font>
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:  #96abc9  ; font-weight:bold;">
                        ...
                        <div class="div-table-cell" style="width: 9%;">Fecha de asignación</div>
                        <div class="div-table-cell" style="width: 9%;">usuario</div>
                        <div class="div-table-cell" style="width: 10%;">Dar mantenimiento</div>
            ...
            $query="SELECT o.fecharegistro,o.claveuser,m.modelo,m.serie,d.folio FROM equipodecomputo AS o inner JOIN regteclado AS m ON o.seriet=m.serie INNER JOIN formatoasignacion AS d on o.seriecomp=d.serie";
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list">
                           <div class="div-table-cell" style="width: 17%;"><?php echo $row['folio'];   ?></div>
                        <div class="div-table-cell" style="width: 15%;"><?php echo $row['serie'];   ?></div>
                        <div class="div-table-cell" style="width: 18%;"><?php echo $row['modelo'];   ?></div>
                       
                       
                        <div class="div-table-cell" style="width: 15%;"><?php echo $row['fecharegistro'];   ?></div>
                        <div class="div-table-cell" style="width: 18%;"><?php echo $row['claveuser'];   ?></div>
                         <a href="formatodemanteniento.html"><div class="div-table-cell" style="width: 1%;">
                                <button class="btn btn-warning"><i class="zmdi zmdi-account-add"></i></button>
                            </div></a>
                        </div>
                    </div>
                </div>
