...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff> 
                    Bienvenido a la sección para modificar a usuario. Para modificar al usuario debes de llenar todos los campos del siguiente formulario.
                        </font>
                </div>
            </div>
        </div>
        ...
        <?php
            ...
            $query="SELECT * FROM usuario WHERE claveuser='$claveuser'";
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form action="modprocesuser.php" method="post" >
                    <div class="row">
                    ...
                    <option value="TCS-CF" >TCS-CF</option>
                     ...
                     <option value="TCS-GERHCF" >TCS-GERHCF</option>
                           ...
                           <font color= #FFFF00>
                            ...
                            <div class="group-material">
                                <input name="claveuser" readonly="" value="<?php echo $row['claveuser'];    ?>" type="text" class="material-control tooltips-general" placeholder=""  maxlength="50" data-toggle="tooltip" data-placement="top" >
                            ...
                            <div class="group-material">
                                <input name="nombre" value="<?php echo $row['nombre'];    ?>"type="text" class="material-control tooltips-general" placeholder="Escribe aquí los nombres del usuario" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,70}" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe los nombres del personal administrativo, solamente letras">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                           ...
                           <font color= #FFFF00>
                            ...
                            <div class="group-material">
                                <input name="apellido" value="<?php echo $row['apellido'];    ?>" type="text" class="material-control tooltips-general" placeholder="Escribe aquí los apellidos del usuario" pattern="[a-z ]+" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe los apellidos del personal administrativo, solamente letras">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                                <input name="numerotel" value="<?php echo $row['numerotel'];    ?>" type="text" class="material-control tooltips-general" placeholder="Escribe aquí el número de teléfono del usuario" pattern="[0-9]{10,10}" required="" maxlength="10" data-toggle="tooltip" data-placement="top" title="Solamente 10 números">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                                <input name="cargo" value="<?php echo $row['cargo'];    ?>" type="text" pattern="[a-z ]+" class="material-control tooltips-general" placeholder="Escribe aquí el cargo del usuario" required="" maxlength="30" data-toggle="tooltip" data-placement="top" title="Cargo del personal administrativo">
                                <span class="highlight"></span>
                                <span class="bar"></span>
