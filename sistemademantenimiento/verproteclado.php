    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de teclados registrados en el sistema.</font><br>
        ...
        $row3=$resultado3->fetch_assoc();
          ...
          ?>
            ...
            $query="SELECT * FROM regteclado WHERE estado  <> 'baja'AND asignado <> 'si' and estado <> '-'";
                ...
                <div class="div-table-cell" style="width: 16%;"><?php echo ''.$p.''        ?></div>
                        ...
                        <div class="div-table-cell" style="width: 16%;"><?php echo $row['fecha'];?></div>
                            ...
                            <div class="div-table-cell" style="width: 16%;">
                             <a href="entregartecladocom.php?serie=<?php echo $row['serie'];?>&seriecomp=<?php  echo "$seriecomp"   ?>&seriecpu=<?php echo "$seriecpu" ?>&seriemonitor=<?php echo "$seriemonitor" ?>">
