...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/service-pc.png" alt="pdf" class="img-responsive center-box" style="max-width: 210px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff> 
                    Bienvenido a la sección de mantenimiento, seleccione que categoria de articulo desea revisar, en cada apartado aparecera una lista de equipos correspondientes que han sido 
                        entregados a un usuario en especifico donde podra asignar fechas para un mantenimiento preventivo asi como cada detalle del equipo.
     ...
     include("conexion.php");
        ...
        $cpu= mysqli_query ($conexion,"SELECT * FROM equipodecomputo ");
         $lap= mysqli_query ($conexion,"SELECT * FROM entregalaptop ");
        
        ?>
        <section class="full-reset text-center" style="padding: 40px 0;">
            <article class="tile"data-href="listequipolaptopentregadas.php" data-num="<?php echo mysqli_num_rows($lap); ?>">
              <a href="listequipolaptopentregadas.php">  <div class="tile-icon full-reset"><i class="zmdi zmdi-laptop"></i></div></a>
                <div class="tile-name all-tittles">laptop </div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($lap); ?></div>
            </article>
            <article class="tile"data-href="listequipocomputo.php" data-num="<?php echo mysqli_num_rows($cpu); ?>">
              <a href="listequipocomputo.php"> <div class="tile-icon full-reset"><i class="zmdi zmdi-memory"></i></div></a> 
                <div class="tile-name all-tittles">pc </div>
