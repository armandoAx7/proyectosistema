...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/lap.png" alt="user" class="img-responsive center-box" style="max-width: 210px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de laptops registrados en el sistema, puedes dar de baja  o asignar algun producto al personal o usuarios siempre y cuando esten registrados en el sistema.</font><br>
        ...
        <div class="container-fluid">
              ...
              <font color= #fff>
            <h2  class="text-center all-tittles" style="clear: both; margin: 25px 0;"> listado de laptops </h2>
                  </font>
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:  #96abc9  ; font-weight:bold;">
                        <div class="div-table-cell" style="width: 7%;">#</div>
                        <div class="div-table-cell" style="width: 7%;">serie</div>
                        <div class="div-table-cell" style="width: 7%;">Marca</div>
                        <div class="div-table-cell" style="width: 7%;">Modelo</div>
                        <div class="div-table-cell" style="width: 7%;">Color</div>
                        <div class="div-table-cell" style="width: 7%;">S.cargador</div>
                        <div class="div-table-cell" style="width: 7%;">Procesador</div>
                          <div class="div-table-cell" style="width: 7%;">T.HDD</div>
                          <div class="div-table-cell" style="width: 7%;">T.RAM</div>
                        <div class="div-table-cell" style="width: 7%;">S.O</div>
                        <div class="div-table-cell" style="width: 7;">Fecha.reg</div>
                       
                        
                        <div class="div-table-cell" style="width: 7%;">Actualizar</div>
                        <div class="div-table-cell" style="width: 7%;">baja</div>
            ...
            $query="SELECT * FROM reglaptop WHERE estado  <> 'baja' AND asignado <> 'si'and tipodisp <> '-'";
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list">
                            <div class="div-table-cell" style="width: 7%;"><?php echo ''.$p.''        ?></div>
                            <div class="div-table-cell" style="width: 7%;"><?php echo $row['serie'];?></div>
                        <div class="div-table-cell" style="width: 7%;"><?php echo $row['marca'];?></div>
                        <div class="div-table-cell" style="width: 7%;"><?php echo $row['modelo'];?></div>
                        <div class="div-table-cell" style="width: 7%;"><?php echo $row['color'];?></div>
                        <div class="div-table-cell" style="width: 7%;"><?php echo $row['seriecargador'];?></div>
                        <div class="div-table-cell" style="width: 7%;"><?php echo $row['procesador'];?></div>
                          <div class="div-table-cell" style="width: 7%;"><?php echo $row['tamanohdd'];?></div>
                          <div class="div-table-cell" style="width: 7%;"><?php echo $row['tamanoram'];?></div>
                        <div class="div-table-cell" style="width: 7%;"> <?php echo $row['tiposo'];?> </div>
                        <div   class="div-table-cell"  style="width: 7;"> <h5><?php echo $row['fecha'];?></h5></div>
                            
                   
                            <div class="div-table-cell" style="width: 7%;">
                                 <a href="modificarlap.php?serie=<?php echo $row['serie'];?>"> <button class="btn btn-success"   ><i class="zmdi zmdi-refresh"></i></button> </a>
                            </div>
                            <div class="div-table-cell" style="width: 7%;">
                                <a href="bajaprolaptop.php?serie=<?php  echo $row['serie'];  ?>">   <button class="btn btn-danger"><i class="zmdi zmdi-delete"></i></button></a>
                            </div>
