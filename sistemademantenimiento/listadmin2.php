    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid">
           <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                ...
                <li role="presentation" class="active"><a href="admin2.php">Administrador secundarios</a></li>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los administradores secundarios, puedes desactivar la cuenta de cualquier administrador o eliminar los datos si no hay préstamos asociados a la cuenta
                        </font>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        <li><a href="admin2.php">Nuevo administrador secundario</a></li>
                        <li class="active">listado de administradores secundarios</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <font color= #fff>
            <h2 class="text-center all-tittles">Lista de administradores secundarios</h2>
                           </font>
            ...
            <div class="div-table">
                <div class="div-table-row div-table-head">
                    ...
                    <div class="div-table-cell">E_MAIL</div>
                    <div class="div-table-cell">NOMBRE_USUARIO</div>
            ...
            $query="SELECT * FROM administrador WHERE privilegio  <> 'administrador'";
                ...
                while ($row=$resultado->fetch_assoc()){
                 ...
                 ?>
                   ...
                   <div class="div-table-row">
                     <div class="div-table-cell"><?php echo ''.$p.''        ?></div>
                    <div class="div-table-cell"><?php echo $row['id'];?></div>
                    <div class="div-table-cell"><?php echo $row['email'];?></div>
                    <div class="div-table-cell"><?php echo $row['nombre'];?></div>
              
                   
                  <div class="div-table-cell">     
                   
                 <a href="admin2modificar.php?id=<?php echo $row['id'];?>"> <button class="btn btn-success"   ><i class="zmdi zmdi-refresh"></i></button> </a>
                   </div> 
                    <div class="div-table-cell">
                  <a href="eliminaradmin2.php?id=<?php echo $row['id'];?>">     <button class="btn btn-danger"><i class="zmdi zmdi-delete"></i></button></a> 
                    </div>
                </div>
