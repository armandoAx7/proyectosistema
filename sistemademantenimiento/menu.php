...
<body>
   ...
   <?php 
     include("conexion.php");
        $administradores= mysqli_query ($conexion,"SELECT * FROM administrador WHERE privilegio <>'administrador2'");
        $administradores2= mysqli_query ($conexion,"SELECT * FROM administrador WHERE privilegio <>'administrador'");
        $usuario= mysqli_query ($conexion,"SELECT * FROM usuario ");
        
        
        ?>
        <section class="full-reset text-center" style="padding: 40px 0;">
            <article class="tile" data-href="menu.php" data-num="<?php echo mysqli_num_rows($administradores); ?>">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-face"></i></div>
                <div class="tile-name all-tittles">administradores</div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($administradores); ?></div>
            </article>
            <article class="tile"data-href="menu.php" data-num="<?php echo mysqli_num_rows($administradores2); ?>">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-accounts"></i></div>
                <div class="tile-name all-tittles">administradores secundarios</div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($administradores2); ?></div>
            </article>
           
            <article class="tile"data-href="menu.php" data-num="<?php echo mysqli_num_rows($usuario); ?>">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-male-alt"></i></div>
                <div class="tile-name all-tittles">usuarios </div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($usuario); ?></div>
            </article>
