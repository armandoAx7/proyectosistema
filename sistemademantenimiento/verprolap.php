    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
            ...
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:  #96abc9  ; font-weight:bold;">
                        ...
                        <div class="div-table-cell" style="width: 8%;">serie</div>
                        <div class="div-table-cell" style="width: 8%;">Marca</div>
                        <div class="div-table-cell" style="width: 8%;">Modelo</div>
                        <div class="div-table-cell" style="width: 8%;">Color</div>
                        <div class="div-table-cell" style="width: 8%;">S.cargador</div>
                        <div class="div-table-cell" style="width: 8%;">Procesador</div>
                          <div class="div-table-cell" style="width: 8%;">T.HDD</div>
                          <div class="div-table-cell" style="width: 8%;">T.RAM</div>
                        <div class="div-table-cell" style="width: 8%;">S.O</div>
                        <div class="div-table-cell" style="width: 8;">Fecha.reg</div>
                       
                        
                        <div class="div-table-cell" style="width: 8%;">Asignar</div>
                    </div>
                </div>
                <?php
        ...
        $row3=$resultado3->fetch_assoc();
          ...
          ?>
            ...
            $query="SELECT * FROM reglaptop WHERE estado  <> 'baja' and estado <> '-' ";
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list">
                            <div class="div-table-cell" style="width: 8%;"><?php echo ''.$p.''        ?></div>
                            <div class="div-table-cell" style="width: 8%;"><?php echo $row['serie'];?></div>
                        <div class="div-table-cell" style="width: 8%;"><?php echo $row['marca'];?></div>
                        <div class="div-table-cell" style="width: 8%;"><?php echo $row['modelo'];?></div>
                        <div class="div-table-cell" style="width: 8%;"><?php echo $row['color'];?></div>
                        <div class="div-table-cell" style="width: 8%;"><?php echo $row['seriecargador'];?></div>
                        <div class="div-table-cell" style="width: 8%;"><?php echo $row['procesador'];?></div>
                          <div class="div-table-cell" style="width: 8%;"><?php echo $row['tamanohdd'];?></div>
                          <div class="div-table-cell" style="width: 8%;"><?php echo $row['tamanoram'];?></div>
                        <div class="div-table-cell" style="width: 8%;"> <?php echo $row['tiposo'];?> </div>
                        <div   class="div-table-cell"  style="width: 8;"> <h5><?php echo $row['fecha'];?></h5></div>
                            
                   
                           
                         <div class="div-table-cell" style="width: 8%;">
                             <a href="entregarlapcomp.php?serie=<?php echo $row['serie'];?>&serieentrega=<?php  echo $row3['serieentrega'];   ?> ">  <button class="btn btn-warning"><i class="zmdi zmdi-account-add"></i></button></a>
                            </div>
                        </div>
                    </div>
                </div>
