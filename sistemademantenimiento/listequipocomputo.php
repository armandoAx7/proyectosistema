...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid">
            ...
            $query="SELECT m.claveuser,m.proceso,o.proyecto,o.seriecomp,d.marca,d.modelo FROM equipodecomputo AS o inner JOIN usuario AS m ON m.claveuser=o.claveuser INNER JOIN regcpu as d on d.serie=o.seriecpu";
   ...
   while ($row=$resultado->fetch_assoc()){
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        ...
                        <div class="div-table-cell" style="width: 14%;"><?php  echo  $row['seriecomp'];?></div>
                       ...
                       <div class="div-table-cell" style="width:14 %; text-align: center;">
                        <a href="formato.php?seriecomp=<?php echo  $row['seriecomp']; ?>">
