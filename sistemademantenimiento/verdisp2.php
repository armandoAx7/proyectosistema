                    ...
                    <div class="div-table-row div-table-row-list" style="background-color:  #96abc9  ; font-weight:bold;">
                       ...
                       <div class="div-table-cell" style="width: 10%;"> macwlan </div>
                        ...
                        <div class="div-table-cell" style="width: 5%;">e.r.pass</div>
                           <div class="div-table-cell" style="width: 10%;"> macwlan </div>
                        <div class="div-table-cell" style="width: 5;">Asignar</div>
                    ...
                    <div class="div-table" style="margin:0 !important;">
                        ...
                        <div class="div-table-cell" style="width: 5%;"> <?php echo $row['tiposo'];?> </div>
                            ...
                            <div class="div-table-cell" style="width: 5%;">
                                <a href="listreportcpulapreg.php?serie=<?php echo $row['serie'];?>"> <button class="btn btn-success"   ><i class="zmdi zmdi-plus"></i></button> </a>
                            </div>
