        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de monitores registrados en el sistema</font><br>
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        ...
                        <div class="div-table-cell" style="width: 16%;"><?php echo $row['fecha'];?></div>
                           ...
                           <a href="entregarmoncomp.php?serie=<?php echo $row['serie'];?>&seriecomp=<?php  echo "$seriecomp"   ?>&seriecpu=<?php echo "$seriecpu" ?>">
