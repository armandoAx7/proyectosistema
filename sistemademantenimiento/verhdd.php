...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/USB-HD-Drive-icon.png" alt="user" class="img-responsive center-box" style="max-width: 210px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de HDD registrados en el sistema, puedes dar de baja  o asignar algun producto al personal o usuarios siempre y cuando esten registrados.</font><br>
        ...
        <div class="container-fluid">
              ...
              <font color= #fff>
            <h2  class="text-center all-tittles" style="clear: both; margin: 25px 0;"> listado de HDD </h2>
                  </font>
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:  #96abc9  ; font-weight:bold;">
                        ...
                        <div class="div-table-cell" style="width: 10%;">serie</div>
                        <div class="div-table-cell" style="width: 10%;">descripcion</div>
                        <div class="div-table-cell" style="width: 10%;">Marca</div>
                        <div class="div-table-cell" style="width: 10%;">Modelo</div>
                       <div class="div-table-cell" style="width: 10%;">Color</div>
                        <div class="div-table-cell" style="width: 10%;">Capacidad</div>
                        <div class="div-table-cell" style="width: 10%;">Fecha.reg</div>
                       
                        
                        <div class="div-table-cell" style="width: 10%;">Actualizar</div>
                        <div class="div-table-cell" style="width: 10%;">baja</div>
            ...
            $query="SELECT * FROM reghdd WHERE estado  <> 'baja' AND asignado <> 'si'and tipodisp <> '-'";
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list">
                            <div class="div-table-cell" style="width: 10%;"><?php echo ''.$p.''        ?></div>
                            <div class="div-table-cell" style="width: 10%;"><?php echo $row['serie'];?></div>
                             <div class="div-table-cell" style="width: 10%;"><?php echo $row['descripcion'];?></div>
                        <div class="div-table-cell" style="width: 10%;"><?php echo $row['marca'];?></div>
                        <div class="div-table-cell" style="width: 10%;"><?php echo $row['modelo'];?></div>
                       <div class="div-table-cell" style="width: 10%;"><?php echo $row['color'];?></div>
                            <div class="div-table-cell" style="width: 10%;"><?php echo $row['capacidad'];?></div>
                            
                        <div class="div-table-cell" style="width:10% ;"><?php echo $row['fecha'];?></div>
                       
                            <div class="div-table-cell" style="width: 10%;">
                                 <a href="modificarhdd.php?serie=<?php echo $row['serie'];?>"> <button class="btn btn-success"   ><i class="zmdi zmdi-refresh"></i></button> </a>
                            </div>
                            <div class="div-table-cell" style="width: 10%;">
                              <a href="bajaprohdd.php?serie=<?php  echo $row['serie'];  ?>">   <button class="btn btn-danger"><i class="zmdi zmdi-delete"></i></button></a>
                            </div>
