...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los tipos de usuarios registrados en el sistema, puedes actualizar algunos datos  o eliminar el registro completo del personal administrativo siempre y cuando no tenga acciones pendientes.</font><br>
                    <strong class="text-danger"><i class="zmdi zmdi-alert-triangle"></i> &nbsp; ¡Importante! </strong> <font color= #fff>Si eliminas el personal administrativo del sistema se borrarán todos los datos relacionados con él. </font>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        <li><a href="personal.php">Nuevo usuario</a></li>
                        <li class="active">Listado de los tipos de usuarios</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
              ...
              <font color= #fff>
            <h2  class="text-center all-tittles" style="clear: both; margin: 25px 0;"> listado de los usuarios </h2>
                  </font>
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:#DFF0D8; font-weight:bold;">
                        <div class="div-table-cell" style="width: 2%;">#</div>
                        <div class="div-table-cell" style="width: 9%;">Proceso</div>
                        <div class="div-table-cell" style="width: 15%;">Clave</div>
                        <div class="div-table-cell" style="width: 15%;">Nombres</div>
                        <div class="div-table-cell" style="width: 12%;">Apellido</div>
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list">
                            <div class="div-table-cell" style="width: 2%;"><?php echo ''.$p.''        ?></div>
                            <div class="div-table-cell" style="width: 9%;"><?php echo $row['proceso'];?></div>
                            <div class="div-table-cell" style="width: 15%;"><?php echo $row['claveuser'];?></div>
                            <div class="div-table-cell" style="width: 15%;"><?php echo $row['nombre'];?></div>
                            <div class="div-table-cell" style="width: 12%;"><?php echo $row['apellido'];?></div>
                            <div class="div-table-cell" style="width: 15%;"><?php echo $row['numerotel'];?></div>
                             <div class="div-table-cell" style="width: 15%;"><?php echo $row['cargo'];?></div>
                           <div class="div-table-cell">     
                   
                 <a href="modificaruser.php?claveuser=<?php echo $row['claveuser'];?>"> <button class="btn btn-success"   ><i class="zmdi zmdi-refresh"></i></button> </a>
                   </div> 
                    <div class="div-table-cell">
                  <a href="eliminaruser.php?claveuser=<?php echo $row['claveuser'];?>">     <button class="btn btn-danger"><i class="zmdi zmdi-delete"></i></button></a> 
                    </div>
                        </div>
                    </div>
                </div>
