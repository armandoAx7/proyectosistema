        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de CPU </font><br>
                    <strong class="text-danger"><i class="zmdi zmdi-alert-triangle"></i> &nbsp; ¡Importante! </strong> <font color= #fff> </font>
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:  #96abc9  ; font-weight:bold;">
                        ...
                        <div class="div-table-cell" style="width: 7%;">Asignar</div>
                    </div>
                </div>
...
<?php
        ...
        $row3=$resultado3->fetch_assoc();
          ...
          ?>
            ...
            $query="SELECT * FROM regcpu WHERE estado  <> 'baja' AND asignado <> 'si' and estado <>'-' ";
                    ...
                    <div class="div-table" style="margin:0 !important;">
                        ...
                        <div   class="div-table-cell"  style="width: 7%;"> <h5><?php echo $row['fecha'];?></h5></div>
                          ...
                          <div class="div-table-cell" style="width: 7%;">
                           <a href="entregarcpucomp.php?serie=<?php echo $row['serie'];?>&seriecomp=<?php  echo "$seriecomp"   ?>">   
                            
                            <button class="btn btn-warning" data-toggle="modal" ><i class="zmdi zmdi-account-add"></i></button> </a>
                             </div>
