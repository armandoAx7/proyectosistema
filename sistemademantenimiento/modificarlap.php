...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid">
            <form autocomplete="off" action="modificarprolap.php?id=<?php echo $row['serie'];    ?>" method="post">
                    ...
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            ...
                            <div class="group-material">
                                ...
                                <input  value="<?php echo $row['marca'];    ?>"  name="marca" type="text" class="tooltips-general material-control" placeholder="Escribe aquí la marca de la laptop"  required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="">
                            ...
                            <div class="group-material">
                                ...
                                <input  value="<?php echo $row['modelo'];    ?>" name="modelo" type="text" class="tooltips-general material-control" placeholder="Escribe aquí el modelo de la laptop" required="" maxlength="70" data-toggle="tooltip" data-placement="top" title="Escribe el modelo de la laptop">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                                ...
                                <input readonly  value="<?php echo $row['serie'];    ?>"  name="serie"type="text" class="tooltips-general material-control" placeholder="Escribe aquí la serie " required="" maxlength="70" data-toggle="tooltip" data-placement="top" title="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                                ...
                                <input  value="<?php echo $row['procesador'];    ?>" name="procesador" type="text" class="material-control tooltips-general" placeholder="Escribe aquí el tipo del procesador" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="tipo de procesador">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                             ...
                             <div class="group-material">
                                ...
                                <input  value="<?php echo $row['tamanohdd'];    ?>"  name="tamanohdd" type="text" class="material-control tooltips-general" placeholder="Escribe aquí el tamaño del HDD" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="tamaño de la memoria hdd">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                             ...
                             <div class="group-material">
                                ...
                                <input  value="<?php echo $row['tamanoram'];    ?>" name="tamanoram" type="text" class="material-control tooltips-general" placeholder="Escribe aquí el tamaño de la memoria RAM" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="tamaño de la memoria ram">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                             ...
                             <div class="group-material">
                                ...
                                <input  value="<?php echo $row['tiposo'];    ?>"  name="tiposo" type="text" class="material-control tooltips-general" placeholder="Escribe aquí el tipo del S.O" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="tipo del sistema operativo">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                               ...
                               <input  value="<?php echo $row['fecha'];    ?>"  name="fecha" type="date" class="material-control tooltips-general" placeholder="Escribe aquí la fecha de registro" required="" pattern="dd/mm/yyyy"   maxlength="4" data-toggle="tooltip" data-placement="top" >
                                <span class="highlight"></span>
                                <span class="bar"></span>
