...
<head>
    ...
    <link rel="Shortcut Icon" type="image/x-icon" href="assets/icons/" />
...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <br><br><br>
        <h3 class="text-center all-tittles">  <font color= #fff>resultados de la búsqueda </font></h3>
        <h2 class="text-center"><img src="assets/img/triste.png" width="150" height="150">  <font color= #fff> <br><br>Lo sentimos, no hemos encontrado ningún producto con el nombre <strong>ingresado</strong> en el sistema   </font></h2>  
