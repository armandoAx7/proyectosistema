...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url();">
        ...
        <form autocomplete="off" action="guardarformatomantenimientolap.php" method="post">
            <div id="muestra">
...
<?php
   include ("conexion.php");
            ...
            $query="SELECT o.proyecto,o.fecharegistro,o.tipodispositivo,o.serieentrega,o.claveuser,m.tipodisp,m.Procesador,m.modelocargador,m.seriecargador,m.marcacargador,m.tamanohdd,m.tamanoram,m.marca,m.modelo,m.serie,d.folio,d.softwares FROM entregalaptop AS o inner JOIN reglaptop AS m ON o.serielap=m.serie INNER JOIN formatoasiglap AS d on o.serieentrega=d.serie  WHERE o.serieentrega='$serieentrega'";
   ...
   include ("conexion.php");
            ...
            $serieentrega=$_REQUEST['serieentrega'];
            $query2="SELECT o.proyecto,o.fecharegistro,o.tipodispositivo,o.serieentrega,m.proceso,d.folio,d.softwares FROM entregalaptop AS o inner JOIN usuario AS m ON o.claveuser=m.claveuser INNER JOIN formatoasiglap AS d on o.serieentrega=d.serie  WHERE o.serieentrega='$serieentrega'";
   ...
   include ("conexion.php");
            ...
            $serieentrega=$_REQUEST['serieentrega'];
            $query3="SELECT o.proyecto,o.fecharegistro,o.tipodispositivo,o.serieentrega,o.claveuser,m.tipodisp,m.marca,m.modelo,m.serie,d.folio,d.softwares FROM entregalaptop AS o inner JOIN regmonitor AS m ON o.seriemonitor=m.serie INNER JOIN formatoasiglap AS d on o.serieentrega=d.serie  WHERE o.serieentrega='$serieentrega'";
   ...
   include ("conexion.php");
            ...
            $serieentrega=$_REQUEST['serieentrega'];
            $query5="SELECT o.proyecto,o.fecharegistro,o.tipodispositivo,o.serieentrega,o.claveuser,m.tipodisp,m.marca,m.modelo,m.serie,d.folio,d.softwares FROM entregalaptop AS o inner JOIN regmouse AS m ON o.seriemouse=m.serie INNER JOIN formatoasiglap AS d on o.serieentrega=d.serie  WHERE o.serieentrega='$serieentrega'";
   ...
   include ("conexion.php");
            ...
            $serieentrega=$_REQUEST['serieentrega'];
            $query6="SELECT o.proyecto,o.fecharegistro,o.tipodispositivo,o.serieentrega,o.claveuser,m.tipodisp,m.marca,m.modelo,m.serie,d.folio,d.softwares FROM entregalaptop AS o inner JOIN regnbrk AS m ON o.seriereg=m.serie INNER JOIN formatoasiglap AS d on o.serieentrega=d.serie  WHERE o.serieentrega='$serieentrega'";
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list"style="background-color:  #DCDAD9  ; font-weight:bold;">
                            <div class="div-table-cell" style="width: 20%;">equipo de computo <input type="text" style="display: none;" name="serieentrega" value="<?php  echo $row['serieentrega']  ?>"></div>
