                    ...
                    <div class="div-table" style="margin:0 !important;">
                        ...
                        <div class="div-table-cell" style="width: 9;"><?php echo $row['fecha'];?></div>
                            ...
                            <div class="div-table-cell" style="width: 9%;">
                                ...
                                <a href="opagregarmonlap.php?seriemonitor=<?php echo $row['serie'];?>&serieentrega=<?php echo $serieentrega  ?>"> <button class="btn btn-success"   ><i class="zmdi zmdi-plus"></i></button> </a>
                            </div>
