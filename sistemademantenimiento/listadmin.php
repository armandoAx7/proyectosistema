    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid">
           <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                ...
                <li role="presentation"><a href="admin2.php">Administrador secundario</a></li>
        ...
        <div class="container-fluid">
            ...
            $query="SELECT * FROM administrador WHERE privilegio  <> 'administrador2'";
            $resultado=$conexion->query($query);   
                while ($row=$resultado->fetch_assoc()){
                 ...
                 <a href="adminmodificar.php?id=<?php echo $row['id'];?>"> <button class="btn btn-success"   ><i class="zmdi zmdi-refresh"></i></button> </a>
                   </div> 
                    <div class="div-table-cell">
                  <a href="eliminaradmin.php?id=<?php echo $row['id'];?>">     <button class="btn btn-danger"><i class="zmdi zmdi-delete"></i></button></a> 
                    </div>
                </div>
