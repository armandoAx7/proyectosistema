...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff> 
                    Bienvenido a la sección para ver los productos que han sido asignados
                        </font>
                </div>
            </div>
        </div>
        ...
        <section class="full-reset text-center" style="padding: 40px 0;">
            <article class="tile">
           <a href="listasiglap%20.html">    <div class="tile-icon full-reset" ><i class="zmdi zmdi-laptop "  ></i>   </div></a>
                
              <div class="tile-name all-tittles">laptop</div> 
                <div class="tile-num full-reset">0</div>
            </article>
            <article class="tile">
              <a href="listasigcpu%20.html">   <div class="tile-icon full-reset"><i class="zmdi zmdi-memory"></i></div></a>
                <div class="tile-name all-tittles">CPU</div>
                <div class="tile-num full-reset">0</div>
            </article>
             <article class="tile">
              <a href="listasigmonitor%20.html">  <div class="tile-icon full-reset"><i class="zmdi zmdi-desktop-windows"></i></div></a>
                <div class="tile-name all-tittles">monitor</div>
                <div class="tile-num full-reset">0</div>
            </article>
             <article class="tile">
               <a href="listasigteclado.html">   <div class="tile-icon full-reset"><i class="zmdi zmdi-keyboard"></i></div></a>
                <div class="tile-name all-tittles">teclado</div>
                <div class="tile-num full-reset">0</div>
            </article>
             <article class="tile">
               <a href="listasigmouse%20.html">    <div class="tile-icon full-reset"><i class="zmdi zmdi-mouse"></i></div></a>
                <div class="tile-name all-tittles">mouse</div>
                <div class="tile-num full-reset">0</div>
            </article>
             <article class="tile">
              <a href="listasigreg-nbrk%20.html">   <div class="tile-icon full-reset"><i class="zmdi zmdi-developer-board"></i></div></a>
                <div class="tile-name all-tittles">reg-nbrk</div>
                <div class="tile-num full-reset">0</div>
            </article>
             <article class="tile">
               <a href="listasigimpre%20.html">  <div class="tile-icon full-reset"><i class="zmdi zmdi-scanner"></i></div></a>
                <div class="tile-name all-tittles">impresora</div>
                <div class="tile-num full-reset">0</div>
            </article>
             <article class="tile">
             <a href="listasigHDD%20.html">     <div class="tile-icon full-reset"><i class="zmdi zmdi-usb"></i></div></a>
                <div class="tile-name all-tittles">HDD</div>
                <div class="tile-num full-reset">0</div>
            </article>
             <article class="tile">
              <a href="listasigdispcom%20.html">   <div class="tile-icon full-reset"><i class="zmdi zmdi-router"></i></div></a>
