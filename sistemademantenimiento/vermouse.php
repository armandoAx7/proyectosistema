...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid">
              ...
              <font color= #fff>
            <h2  class="text-center all-tittles" style="clear: both; margin: 25px 0;"> listado de mouses </h2>
                  </font>
            ...
            $query="SELECT * FROM regmouse WHERE estado  <> 'baja' AND asignado <> 'si'and tipodisp <> '-'";
                    ...
                    <div class="div-table" style="margin:0 !important;">
                        ...
                        <div class="div-table-cell" style="width: 9;"><?php echo $row['fecha'];?></div>
                            ...
                            <div class="div-table-cell" style="width: 9%;">
                                 <a href="modificarmause.php?serie=<?php echo $row['serie'];?>"> <button class="btn btn-success"   ><i class="zmdi zmdi-refresh"></i></button> </a>
                            </div>
                            <div class="div-table-cell" style="width: 5%;">
                                <a href="bajapromouse.php?serie=<?php  echo $row['serie'];  ?>">   <button class="btn btn-danger"><i class="zmdi zmdi-delete"></i></button></a>
                            </div>
