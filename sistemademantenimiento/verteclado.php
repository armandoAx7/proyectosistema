...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/Hardware-Keyboard-icon.png" alt="user" class="img-responsive center-box" style="max-width: 210px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de teclados registrados en el sistema, puedes dar de baja  o asignar algun producto al personal o usuarios siempre y cuando esten registrados.</font><br>
        ...
        <div class="container-fluid">
              ...
              <font color= #fff>
            <h2  class="text-center all-tittles" style="clear: both; margin: 25px 0;"> listado de teclados </h2>
                  </font>
                    ...
                    <div class="div-table-row div-table-row-list" style="background-color:  #96abc9  ; font-weight:bold;">
                       ...
                       <div class="div-table-cell" style="width: 14%;">Modelo</div>
                        ...
                        <div class="div-table-cell" style="width: 14%;">Fecha.reg</div>
                          ...
                          <div class="div-table-cell" style="width: 14%;">modificar</div>
            ...
            $query="SELECT * FROM regteclado WHERE estado  <> 'baja'AND asignado <> 'si'and tipodisp <> '-'";
                ...
                <div class="div-table-cell" style="width: 14%;"><?php echo ''.$p.''        ?></div>
                        ...
                        <div class="div-table-cell" style="width: 14%;"><?php echo $row['fecha'];?></div>
                            ...
                            <div class="div-table-cell" style="width: 14%;">
                                 <a href="modificarteclado.php?serie=<?php echo $row['serie'];?>"> <button class="btn btn-success"   ><i class="zmdi zmdi-refresh"></i></button> </a>
                            </div>
                            <div class="div-table-cell" style="width: 14%;">
                                <a href="bajaproteclado.php?serie=<?php  echo $row['serie'];  ?>">   <button class="btn btn-danger"><i class="zmdi zmdi-delete"></i></button></a>
                            </div>
