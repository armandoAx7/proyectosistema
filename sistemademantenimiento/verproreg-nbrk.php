        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de reg-nbrk registrados en el sistema</font><br>
                    ...
                    <div class="div-table" style="margin:0 !important;">
                        ...
                        <div class="div-table-cell" style="width: 14;"><?php echo $row['fecha'];?></div>
                           ...
                           <div class="div-table-cell" style="width: 14%;">
                            <a  href="entregarregcomp.php?serie=<?php echo $row['serie'];?>&seriecomp=<?php  echo "$seriecomp"   ?>&seriecpu=<?php echo "$seriecpu" ?>&seriemonitor=<?php echo "$seriemonitor" ?>&seriet=<?php echo "$seriet" ?>&seriemouse=<?php echo "$seriemouse"  ?>&serieimpresora=<?php echo "$serieimpresora"  ?>&seriehdd=<?php echo "$seriehdd"  ?>">
