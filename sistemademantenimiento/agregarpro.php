    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff> 
                    Bienvenido a la sección para agregar nuevos articulos, seleccione que categoria de articulo desea registrar
                        </font>
                </div>
            </div>
        </div>
     ...
     include("conexion.php");
        ...
        <section class="full-reset text-center" style="padding: 40px 0;">
            <article class="tile" data-href="agregarlap.php" data-num="<?php echo mysqli_num_rows($laptop); ?>">
            <a href="agregarlap.php"> <div class="tile-icon full-reset" ><i class="zmdi zmdi-laptop "  ></i>   </div></a>
                
                <div class="tile-name all-tittles">laptop</div>  
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($laptop); ?></div>
            </article>
            
            <article class="tile"data-href="agregarcpu.php" data-num="<?php echo mysqli_num_rows($cpu); ?>">
               <a href="agregarcpu.php"> <div class="tile-icon full-reset"><i class="zmdi zmdi-memory"></i></div></a>
                <div class="tile-name all-tittles">CPU</div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($cpu); ?></div>
            </article>
            
             <article class="tile" data-href="agregarmonitor.php" data-num="<?php echo mysqli_num_rows($monitor); ?>">
             <a href="agregarmonitor.php">  <div class="tile-icon full-reset"><i class="zmdi zmdi-desktop-windows"></i></div></a>
                <div class="tile-name all-tittles">monitor</div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($monitor); ?></div>
            </article>
             <article class="tile" data-href="agregarteclado.php" data-num="<?php echo mysqli_num_rows($teclado); ?>">
           <a href="agregarteclado.php">  <div class="tile-icon full-reset"><i class="zmdi zmdi-keyboard"></i></div></a>
                <div class="tile-name all-tittles">teclado</div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($teclado); ?></div>
            </article>
            
             <article class="tile " data-href="agregarmause.php" data-num="<?php echo mysqli_num_rows($mouse); ?>">
              <a href="agregarmause.php">   <div class="tile-icon full-reset"><i class="zmdi zmdi-mouse"></i></div></a>
                <div class="tile-name all-tittles">mouse</div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($mouse); ?></div>
            </article>
            
             <article class="tile"data-href="agregar-regnbrk.php" data-num="<?php echo mysqli_num_rows($regnbrk); ?>">
             <a href="agregar-regnbrk.php"> <div class="tile-icon full-reset"><i class="zmdi zmdi-developer-board"></i></div></a>
                <div class="tile-name all-tittles">reg-nbrk</div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($regnbrk); ?></div>
            </article>
            
             <article class="tile"data-href="agregarimpresora.php" data-num="<?php echo mysqli_num_rows($impresora); ?>">
           <a href="agregarimpresora.php"> <div class="tile-icon full-reset"><i class="zmdi zmdi-scanner"></i></div></a>
                <div class="tile-name all-tittles">impresora</div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($impresora); ?></div>
            </article>
             <article class="tile" data-href="agregarhdd.php" data-num="<?php echo mysqli_num_rows($hdd); ?>">
           <a href="agregarhdd.php">    <div class="tile-icon full-reset"><i class="zmdi zmdi-usb"></i></div></a> 
                <div class="tile-name all-tittles">HDD</div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($hdd); ?></div>
            </article>
             <article class="tile" data-href="agregardisp-comp.php" data-num="<?php echo mysqli_num_rows($dispcom); ?>">
            <a href="agregardisp-comp.php">   <div class="tile-icon full-reset"><i class="zmdi zmdi-router"></i></div></a>
