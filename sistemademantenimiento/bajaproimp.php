...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid">
            <form autocomplete="off" action="opbajaimpresora.php?serie=<?php echo $row['serie'];    ?>" method="post">
                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <div class="group-material">
                            ...
                            <div class="group-material">
                                ...
                                <input name="observaciones" type="text" class="material-control tooltips-general" placeholder=""   required maxlength="150" data-toggle="tooltip" data-placement="top" title="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
