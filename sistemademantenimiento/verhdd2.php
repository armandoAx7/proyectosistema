            ...
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:  #96abc9  ; font-weight:bold;">
                        ...
                        <div class="div-table-cell" style="width: 9%;">serie</div>
                        <div class="div-table-cell" style="width: 9%;">descripcion</div>
                        <div class="div-table-cell" style="width: 9%;">Marca</div>
                        <div class="div-table-cell" style="width: 9%;">Modelo</div>
                       <div class="div-table-cell" style="width: 9%;">Color</div>
                        <div class="div-table-cell" style="width: 9%;">Capacidad</div>
                        <div class="div-table-cell" style="width: 2%;">Fecha.reg</div>
                       
                        
                        <div class="div-table-cell" style="width: 9%;">Asignar</div>
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list">
                            <div class="div-table-cell" style="width: 9%;"><?php echo ''.$p.''        ?></div>
                            <div class="div-table-cell" style="width: 9%;"><?php echo $row['serie'];?></div>
                             <div class="div-table-cell" style="width: 9%;"><?php echo $row['descripcion'];?></div>
                        <div class="div-table-cell" style="width: 9%;"><?php echo $row['marca'];?></div>
                        <div class="div-table-cell" style="width: 9%;"><?php echo $row['modelo'];?></div>
                       <div class="div-table-cell" style="width: 9%;"><?php echo $row['color'];?></div>
                            <div class="div-table-cell" style="width: 9%;"><?php echo $row['capacidad'];?></div>
                            
                        <div class="div-table-cell" style="width:2% ;"><?php echo $row['fecha'];?></div>
