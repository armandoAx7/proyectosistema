...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6">
                            <div class="report-content">
                               <a href="./proceso/Backup.php"> <p class="text-center"><i class="zmdi zmdi-cloud-download zmdi-hc-4x"></i></p></a>
                        ...
                        <div class="col-xs-12 col-md-6">
                            <div class="report-content">
                                ...
                                <form action="./proceso/Restore.php" method="POST">
       <p class="text-center" > <label >Selecciona un punto de restauración</label><br></p>
         <p class="text-center" >  <select name="restorePoint">
          <option value="" disabled="" selected=""><h2>Selecciona un punto de restauración</h2></option>
            <?php
       ...
       <button type="submit" >Restaurar</button> </p>
    </form>
                            </div>
                        </div>
