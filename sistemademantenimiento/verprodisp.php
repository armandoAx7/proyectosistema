...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de dispositivos de comunicacion registrados en el sistema.</font><br>
        ...
        <div class="container-fluid">
              ...
              <font color= #fff>
            <h2  class="text-center all-tittles" style="clear: both; margin: 25px 0;"> listado de disp.comp </h2>
                  </font>
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        ...
                        <div   class="div-table-cell"  style="width: 6%;"> <?php echo $row['fecha'];?></div>
                           ...
                           <a href="entregardispcomp.php?serie=<?php echo $row['serie'];?>&seriecomp=<?php  echo "$seriecomp"   ?>&seriecpu=<?php echo "$seriecpu" ?>&seriemonitor=<?php echo "$seriemonitor" ?>&seriet=<?php echo "$seriet" ?>&seriemouse=<?php echo "$seriemouse"  ?>&serieimpresora=<?php echo "$serieimpresora"  ?>&seriehdd=<?php echo "$seriehdd"  ?>&seriereg=<?php echo "$seriereg"  ?> ">
