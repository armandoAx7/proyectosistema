...
<body>
    ...
    $serieentrega=$_REQUEST['serieentrega'];
        ...
        ?>
             ...
             <article class="tile" data-href="vermonitor2.php?serieentrega=<?php echo $serieentrega   ?>" data-num="<?php echo mysqli_num_rows($monitor); ?>">
               <div class="tile-icon full-reset"><i class="zmdi zmdi-desktop-windows"></i></div>
                <div class="tile-name all-tittles">monitor</div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($monitor); ?></div>
            </article>
             <article class="tile" data-href="verteclado2.php" data-num="<?php echo mysqli_num_rows($teclado); ?>">
             <div class="tile-icon full-reset"><i class="zmdi zmdi-keyboard"></i></div>
                <div class="tile-name all-tittles">teclado</div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($teclado); ?></div>
            </article>
            
             <article class="tile " data-href="vermause2.php" data-num="<?php echo mysqli_num_rows($mouse); ?>">
                 <div class="tile-icon full-reset"><i class="zmdi zmdi-mouse"></i></div>
                <div class="tile-name all-tittles">mouse</div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($mouse); ?></div>
            </article>
            
             <article class="tile"data-href="ver-reg-nbrk2.php" data-num="<?php echo mysqli_num_rows($regnbrk); ?>">
              <div class="tile-icon full-reset"><i class="zmdi zmdi-developer-board"></i></div>
                <div class="tile-name all-tittles">reg-nbrk</div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($regnbrk); ?></div>
            </article>
            
             <article class="tile"data-href="verimp2.php" data-num="<?php echo mysqli_num_rows($impresora); ?>">
            <div class="tile-icon full-reset"><i class="zmdi zmdi-scanner"></i></div>
                <div class="tile-name all-tittles">impresora</div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($impresora); ?></div>
            </article>
             <article class="tile" data-href="verhdd2.php" data-num="<?php echo mysqli_num_rows($hdd); ?>">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-usb"></i></div>
                <div class="tile-name all-tittles">HDD</div>
                <div class="tile-num full-reset"><?php echo mysqli_num_rows($hdd); ?></div>
            </article>
             <article class="tile" data-href="verdisp2.php" data-num="<?php echo mysqli_num_rows($dispcom); ?>">
               <div class="tile-icon full-reset"><i class="zmdi zmdi-router"></i></div>
