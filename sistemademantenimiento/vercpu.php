...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/chip.png" alt="user" class="img-responsive center-box" style="max-width: 210px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    Bienvenido a la sección donde se encuentra el listado de los equipos de CPU registrados en el sistema, puedes dar de baja  o asignar algun producto al personal o usuarios siempre y cuando esten registrados.</font><br>
        ...
        <div class="container-fluid">
              ...
              <font color= #fff>
            <h2  class="text-center all-tittles" style="clear: both; margin: 25px 0;"> listado de CPU </h2>
                  </font>
            ...
            $query="SELECT * FROM regcpu WHERE estado  <> 'baja' AND asignado <> 'si'and tipodisp <> '-' ";
                    ...
                    <div class="div-table" style="margin:0 !important;">
                        ...
                        <div   class="div-table-cell"  style="width: 7%;"> <h5><?php echo $row['fecha'];?></h5></div>
                            ...
                            <div class="div-table-cell" style="width: 7%;">
                                <a href="modificarcpu.php?serie=<?php echo $row['serie'];?>"> <button class="btn btn-success"   ><i class="zmdi zmdi-refresh"></i></button> </a>
                            </div>
                            <div class="div-table-cell" style="width: 7%;">
                                <a href="bajacpu.php?serie=<?php echo $row['serie'];?>">   <button class="btn btn-danger"><i class="zmdi zmdi-delete"></i></button></a>
                            </div>
                        </div> </div> 
                </div>
