...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/Monitor-icon.png" alt="pdf" class="img-responsive center-box" style="max-width: 210px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff> 
                    Bienvenido a la sección para modificar articulos de la categoria Monitor 
                        </font>
                </div>
            </div>
        </div>
         ...
         <?php
            ...
            $query="SELECT * FROM regmonitor WHERE serie='$serie'";
        ...
        <div class="container-fluid">
            <form autocomplete="off" action="modificarmonitorpro.php?serie=<?php echo $row['serie'];    ?>" method="post">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Nuevo monitor</div>
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <div class="group-material">
                                ...
                                <input name="marca" type="text"  value="<?php echo $row['marca'];    ?>"class="tooltips-general material-control" placeholder="Escribe aquí la marca del monitor" required="" maxlength="20" data-toggle="tooltip" data-placement="top" >
                            ...
                            <div class="group-material">
                                ...
                                <input name="modelo" type="text" value="<?php echo $row['modelo'];    ?>" class="tooltips-general material-control" placeholder="Escribe aquí el modelo del monitor" required="" maxlength="20" data-toggle="tooltip" data-placement="top" >
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                                ...
                                <input name="serie" type="text" value="<?php echo $row['serie'];    ?>" class="tooltips-general material-control" placeholder="Escribe aquí la serie " required="" maxlength="20" data-toggle="tooltip" data-placement="top" >
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                               ...
                               <input name="fecha" type="text" value="<?php echo $row['fecha'];    ?>" class="material-control tooltips-general" placeholder="Escribe aquí la fecha de registro" required="dd/mm/yyyy"  maxlength="" data-toggle="tooltip" data-placement="top" >
                                <span class="highlight"></span>
                                <span class="bar"></span>
