        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff> 
                    Bienvenido a la sección para agregar nuevos articulos de la categoria Monitor 
                        </font>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <form autocomplete="off" action="agregarmonitorbd.php" method="post">
                    ...
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <div class="group-material">
                                ...
                                <input name="marca" type="text" class="tooltips-general material-control" placeholder="Escribe aquí la marca del monitor" required="" maxlength="20" data-toggle="tooltip" data-placement="top" >
                            ...
                            <div class="group-material">
                                ...
                                <input name="modelo" type="text" class="tooltips-general material-control" placeholder="Escribe aquí el modelo del monitor" required="" maxlength="20" data-toggle="tooltip" data-placement="top" >
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                                ...
                                <input name="serie" type="text" class="tooltips-general material-control" placeholder="Escribe aquí la serie " required="" maxlength="20" data-toggle="tooltip" data-placement="top" >
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                               ...
                               <input name="fecha" type="date" class="material-control tooltips-general" placeholder="Escribe aquí la fecha de registro" required="dd/mm/yyyy"  maxlength="" data-toggle="tooltip" data-placement="top" >
                                <span class="highlight"></span>
                                <span class="bar"></span>
