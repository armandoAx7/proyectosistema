        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/mouse.png" alt="pdf" class="img-responsive center-box" style="max-width: 210px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff> 
                    Bienvenido a la sección para agregar nuevos articulos de la categoria Mouse 
                        </font>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <form autocomplete="off" action="agregarmousebd.php" method="post">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Nuevo mouse</div>
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            ...
                            <div class="group-material">
                                ...
                                <input name="marca" type="text" class="tooltips-general material-control" placeholder="Escribe aquí el modelo del mouse" required="" maxlength="20" data-toggle="tooltip" data-placement="top" >
                            ...
                            <div class="group-material">
                                ...
                                <input name="modelo" type="text" class="tooltips-general material-control" placeholder="Escribe aquí el modelo del mouse" required="" maxlength="20" data-toggle="tooltip" data-placement="top" >
                                <span class="highlight"></span>
                                <span class="bar"></span>
