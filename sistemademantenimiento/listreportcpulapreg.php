...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers full-cover-background" style="background-image:url(assets/img/grid-4.png);">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/EQUIPO.png" alt="user" class="img-responsive center-box" style="max-width: 210px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <font color= #fff>
                    selecciona el tipo de dispostivo al que deseas asignarle un nuevo elemento haciendo click en el simbolo de mas.</font>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <form class="pull-right" style="width: 30% !important;" autocomplete="off">
              ...
              <font color= #fff>
            <h2  class="text-center all-tittles" style="clear: both; margin: 25px 0;"> listado de equipos</h2>
                  </font>
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:  #96abc9  ; font-weight:bold;">
             <div class="div-table-cell" style="width: 20%;">seriecomp</div>
                        <div class="div-table-cell" style="width: 20%;">tipo</div>
                        <div class="div-table-cell" style="width: 20%;">usuario</div>
                        <div class="div-table-cell" style="width: 20%;">area</div>
                           
                       
                       
                      
                        <div class="div-table-cell" style="width: 20%;">asignar</div>
            ...
            $query="SELECT m.claveuser,m.proceso,o.tipodispositivo,o.proyecto,o.seriecomp FROM equipodecomputo AS o inner JOIN usuario AS m ON m.claveuser=o.claveuser ";
   ...
   while ($row=$resultado->fetch_assoc()){
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list">
                              <div class="div-table-cell" style="width: 20%;"><?php echo $row['seriecomp'];   ?></div>
                             <div class="div-table-cell" style="width: 20%;"><?php echo $row['tipodispositivo'];   ?></div>
                        <div class="div-table-cell" style="width: 20%;"><?php echo $row['claveuser'];   ?></div>
                        <div class="div-table-cell" style="width: 20%;"><?php echo $row['proceso'];   ?></div>
                     
                     
                         <div class="div-table-cell" style="width: 20%;">
                              <a href="proasignuevos.php?seriecomp=<?php echo $row['seriecomp']   ?>"> <button class="btn btn-primary"><i class="zmdi zmdi-plus"></i></button> </a> 
                            </div>
            ...
            $query2="SELECT m.claveuser,m.proceso,o.tipodispositivo,o.proyecto,o.serieentrega FROM entregalaptop AS o inner JOIN usuario AS m ON m.claveuser=o.claveuser ";
   ...
   while ($row2=$resultado2->fetch_assoc()){
                ...
                <div class="table-responsive">
                    <div class="div-table" style="margin:0 !important;">
                        <div class="div-table-row div-table-row-list">
                            <div class="div-table-cell" style="width: 20%;"><?php echo $row2['serieentrega'];   ?></div>
                             <div class="div-table-cell" style="width: 20%;"><?php echo $row2['tipodispositivo'];   ?></div>
                        <div class="div-table-cell" style="width: 20%;"><?php echo $row2['claveuser'];   ?></div>
                        <div class="div-table-cell" style="width: 20%;"><?php echo $row2['proceso'];   ?></div>
                     
                      
                       
                         <div class="div-table-cell" style="width: 20%;">
                              <a href="proasignuevos.php?serieentrega=<?php echo $row2['serieentrega']   ?>"> <button class="btn btn-primary"><i class="zmdi zmdi-plus"></i></button> </a> 
                            </div>
